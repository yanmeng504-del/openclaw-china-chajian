...
已修复，使用最新插件版本即可。
> 【已修复，此提醒暂时保留】注意：OpenClaw 3.1+ 版本中使用企业微信存在问题，插件端正在尝试修复(或者等待OpenClaw官方修复此问题)，请先使用 3.1 之前的OpenClaw版本。`npm install -g openclaw@2026.2.26`
> 具体原因：网关分发顺序变更导致插件 HTTP 在内置路由之后执行，在到达插件前被拦截。
